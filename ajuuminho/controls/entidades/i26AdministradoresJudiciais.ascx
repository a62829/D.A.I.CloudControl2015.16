...
<div class="ViewsBoxNoPadding" runat="server" id="ViewsBoxNoPadding">
    ...
    <div class="ViewsButtonsBox">
        ...
        <asp:Button Text="Pesquisar" BorderStyle="None" ID="TabPesquisarAdministradorJudicialID" CssClass="Initial" runat="server"
            OnClick="TabPesquisarAdministradorJudicial_Click" />
    </div>
    ...
    <div class="ViewBoxCRUD" runat="server" id="ViewBoxVisible" visible="false">
        <div class="InsideViewsBox">
            ...
            <div id="ContentButtonsBox">
                ...
                <asp:Button ID="ButtonEditarID" runat="server" Text="Editar" CssClass="ContentButton" OnClick="ButtonEditarID_Click" Visible="false" OnClientClick="return entidadeValida()"/>
