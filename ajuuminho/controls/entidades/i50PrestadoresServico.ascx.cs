...
namespace ajuUminho.controls.entidades
{
    public partial class i50PrestadoresServico : System.Web.UI.UserControl
    {
            ...
            protected void ButtonCriarID_Click(object sender, EventArgs e)
            {
                ...
                ps.guardar(TextBoxNomeID.Text, TextBoxMoradaID.Text, TextBoxCodPostalID.Text, TextBoxLocalidadeID.Text,
                    TextBoxEmailID.Text, TextBoxTelefoneID.Text, TextBoxTelemovelID.Text, TextBoxFaxID.Text, TextBoxCcID.Text, TextBoxIbanID.Text,
                    TextBoxNifID.Text, TextBoxLastChangedID.Text);

                string mystring = "Prestador Serviço criado com sucesso.";
