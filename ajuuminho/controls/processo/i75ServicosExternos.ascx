    ...
    <div class="InsideViewsDetailsBox" runat="server" id="ContentDetailsBox" visible="false">
        <div class="titleh4big" runat="server" id="DetailsTitleBox" visible="false">
            ...
            <table class="ContentTable">
                ...
                <tr>
                    <td>
                        <asp:Label ID="LabelPrestadorID" runat="server" Text="Label" CssClass="Labels-Item"> 
                          Prestador: </asp:Label>
                    </td>
                    <td>
                        <asp:TextBox ID="TextBoxPrestadorID" runat="server" CssClass="LabelsInputs-Item"></asp:TextBox>
                    </td>
                </tr>
            </table>
